...
Vehicles and structures are read-only entities in the API—only towers can be removed.
...
Only issue `DELETE` requests against towers you intend to remove from both the API and UI.
